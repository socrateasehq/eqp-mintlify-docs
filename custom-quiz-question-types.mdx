...
For every question, you can set a **timer**, **points**, and **negative points** while creating the quiz. You can also choose whether candidates see questions one at a time or all at once; see [Quiz Display Modes](/quiz-display-modes) for the trade-offs.
...
<Tip>
Negative marking is optional in custom quizzes. If you use the auto-calculate option, negative points equal the question's points divided by the number of options. Negative points are never auto-assigned to MCAs. See [Negative Marking](/negative-marking).
</Tip>
