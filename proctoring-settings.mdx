...
description: "Every proctoring option, its default, and how to configure it per test."
---
...
<Frame caption="The Proctoring Settings panel with its toggles">
  <img src="/images/proctoring-settings-toggles.png" alt="Proctoring Settings panel for a Quiz showing 11 toggles including Detect Audio, Detect Face, and Record User Session" style={{ maxWidth: '450px' }} />
</Frame>
...
<Frame caption="Edit Settings link for each test in the Test Order tab">
  <img src="/images/proctoring-settings-edit-settings-link.png" alt="Test Order tab with an Edit Settings link under the Proctoring column for each test" />
</Frame>
