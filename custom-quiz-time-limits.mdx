...
<!-- screenshot: custom quiz editor showing the per-question timer field -->
...
| Display mode | How questions appear | Where the time limit goes |
|---|---|---|
| **One-by-one** (screen-by-screen) | One question per screen, like Typeform | Per question only |
| **All-at-once** | Every question on one page, like Google Forms | Whole test only |
