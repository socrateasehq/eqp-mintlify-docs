...
The Overall Score is the weightage-weighted combination of each test's percentage score:
...
A reliable approach is relative shortlisting: sort candidates by Overall Score and take the top N into the next round. You can then update statuses (**Shortlisted**, **Rejected**, **Hired**) individually or in bulk. For guidance on choosing a threshold, see [What Is a Good Assessment Score?](/good-assessment-score).
