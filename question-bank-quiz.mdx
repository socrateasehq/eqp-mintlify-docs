...
| **Answer Any** group | Candidate chooses which N of M questions to answer | Giving candidates a choice, such as picking essay prompts |
...
The **Answer Any** question type groups several questions together and asks the candidate to answer any N of them. For example, you can present 4 short-answer prompts and require responses to any 2.

Unlike a Question Pool, the candidate sees all the questions in the group and decides which ones to attempt. This suits open-ended sections where letting candidates play to their strengths is the point.
