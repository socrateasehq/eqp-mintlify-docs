...
<Steps>
  ...
  <Step title="Paste the spreadsheet URL in assessment settings">
    ...
    <Frame caption="The Write results to Google Sheets field in assessment settings">
      <img src="/images/write-results-to-google-sheets-url-field.png" alt="Write results to Google Sheets toggle set to Yes, with the hello@equip.co Editor permission note and a Google Sheets URL field" />
    </Frame>
  </Step>
