...
<Frame caption="Adding a test from the Tests tab">
  <img src="/images/testing-multiple-skills-adding-tests.png" alt="Tests tab showing a quiz configured with two skills and the Add Skill and Add Quiz options" style={{ maxWidth: '600px' }} />
</Frame>
...
<Frame caption="Adding multiple skills to the same quiz">
  <img src="/images/testing-multiple-skills-adding-skills.png" alt="Tests tab with two skills, Data Structures and Algorithms and Python, added to the same quiz" style={{ maxWidth: '600px' }} />
</Frame>
...
<Frame caption="Setting weightage for each test in the Test Order tab">
  <img src="/images/testing-multiple-skills-weightage.png" alt="Test Order tab with weightage inputs of 40, 30, and 30 across three tests" />
</Frame>
