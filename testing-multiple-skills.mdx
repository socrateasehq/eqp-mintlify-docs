...
<Frame caption="Adding a test from the Tests tab">
  <img src="/images/testing-multiple-skills-adding-tests.png" alt="Tests tab showing a quiz configured with two skills and the Add Skill and Add Quiz options" />
</Frame>
...
<Frame caption="Adding multiple skills to the same quiz">
  <img src="/images/testing-multiple-skills-adding-skills.png" alt="Tests tab with two skills, Data Structures and Algorithms and Python, added to the same quiz" />
</Frame>
