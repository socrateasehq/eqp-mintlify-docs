...
We strongly recommend the first approach. Candidates attempt a single quiz instead of starting several, and you see one quiz score, which makes comparing and shortlisting candidates much simpler.
