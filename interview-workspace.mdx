...
<Steps>
  ...
  <Step title="Set the answer format per item">
    Once the Workspace is enabled, every topic and question in your interview gets an **Answer format** selector. Review each item and decide whether the candidate should speak, write, or choose for themselves.
  </Step>
</Steps>
...
The Workspace has two tabs on the candidate side: a **code editor** with syntax highlighting and a **plain text** area for prose answers and notes.
...
The plain text tab works the same way for non-code answers: candidates type their response directly into the panel while the conversation continues.
...
- [AI Interview Settings](/interview-settings) - Every other toggle on the conversational settings page
