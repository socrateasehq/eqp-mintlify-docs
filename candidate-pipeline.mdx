...
The **Candidate Pipeline** is the third and final step of the job creation wizard, after Job Post and Application Form. Here you define the stages candidates move through, from application to hire, and the automations attached to each stage.

Everything you set up here can be changed later. Open the job's Settings page and switch to the **Candidate Pipeline** tab to edit stages after the job is live.

<!-- screenshot: pipeline builder in step 3 of the job creation wizard, showing stage cards -->

## Choosing Stages

Every pipeline starts with the **Applied** stage. It is a system stage, always comes first, and is where every new application lands. From there, you add the stages that match your hiring process.
...
<Note>
When you add a **One-Way AI Interview** or **Conversational AI Interview** stage, Equip automatically creates the interview for that stage. You can then review and adjust it before inviting candidates.
</Note>

The three terminal stages (**Hired**, **Rejected**, **Withdrawn**) and the system stages cannot be deleted. They are the fixed endpoints of every pipeline.
