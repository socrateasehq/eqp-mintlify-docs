...
<Steps>
  ...
  <Step title="Choose sending options">
    Optionally set a **Reply-To** team member so candidate replies reach a real inbox. Without one, the email is sent from no-reply@equip.co. You can also use **Schedule Send** to delay delivery by minutes, hours, or days, up to 7 days ahead.
  </Step>
  <Step title="Send">
