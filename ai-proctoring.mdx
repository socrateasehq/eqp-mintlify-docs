...
<Frame caption="A candidate's Trust Score and session details">
  <img src="/images/ai-proctoring-trust-score.png" alt="Candidate proctoring report showing a 65% Trust Score, tracking icons, and session start and submission times" />
</Frame>
...
<Frame caption="Violations listed with timestamps and evidence">
  <img src="/images/ai-proctoring-violations.png" alt="Proctoring tab listing violations such as switched applications, a random photo, and noise detected, each with a timestamp and evidence" />
</Frame>
