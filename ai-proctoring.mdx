...
When the test ends, Equip generates a proctoring report for the candidate. It includes a **Trust Score** and every detected violation with its timestamp and supporting evidence, such as a photo, screenshot, or audio recording.
