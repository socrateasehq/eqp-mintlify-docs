...
<Steps>
  ...
  <Step title="Copy your public URL">
    Your page is live at `https://equip.co/companies/{slug}/hiring/`. Use the copy button to grab the URL, or open it in a new tab to see it as candidates will.
  </Step>
</Steps>
...
The public page shows every job post with the **Published** status. Jobs you set to Hidden or Archived do not appear, so the page stays in sync with your pipeline without any manual updates.

Each job appears as a card showing its **work arrangement**, **employment type**, **locations**, and **mandatory skills**. Candidates click through to the full job post and apply directly.
