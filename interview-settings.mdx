...
If you enable **Record User Session**, the candidate's report gains a **Session Recording** tab; enabling any proctoring option adds a **Proctoring** tab. See [Interview Reports](/interview-reports) for how the evidence appears.

<!-- screenshot: expanded Proctoring Settings section with toggles -->

## Other Settings

A few more options live in the settings section, some of which are being rolled out gradually and may not appear for every team yet.
