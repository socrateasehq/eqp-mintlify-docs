...
Each assessment is made up of one or more **tests**. A test evaluates one skill or format: a quiz, a programming challenge, a video response, an English communication test, and so on.
...
A **Custom Test** is a test you build with your own questions, such as a custom quiz or a video response test. Once created, you can reuse it across assessments.
