...
Parsing typically takes **30 to 45 seconds** for a self-apply upload. If parsing does not complete, the candidate can simply fill in the form manually.
...
<Warning>
Only supported file types are parsed. Application-form and bulk-import uploads must be **PDF files of 10 MB or less**. Scanned image-only PDFs with no selectable text are the most common cause of a parsing failure.
</Warning>
