...
When you make your first purchase, Equip's payment gateway collects your business details: company name, address, tax information, and so on. These details appear on every invoice, so it is worth fixing errors as soon as you spot them.
...
<Steps>
  ...
  <Step title="Go to Billing">
    On the Purchase Credits page, click **Go to Billing**. This opens your Billing Portal.
